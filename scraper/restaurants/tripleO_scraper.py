...
class TripleOsCanadaScraper:
    def __init__(self):
        self.restaurant_id = "triple_os_ca"
        self.restaurant_name = "Triple O’s (Canada)"
        self.source_url = "https://diqidopw2893b.cloudfront.net/2025/07/02144402/Nutrition-June-2025.pdf"
    ...
    def parse_item_line(self, line: str):
        ...
        name = self.clean_cell(" ".join(parts[: i + 1]))
        ...
        sodium_mg = self.pick_first_number(nums[6])
        carbs_g = self.pick_first_number(nums[7])
        sugar_g = self.pick_first_number(nums[9])
    ...
    def scrape(self):
        pdf_path = self.download_pdf(self.pdf_url, Path("data/triple_os_nutrition.pdf"))
