...
class TheKegCanadaScraper:
    def __init__(self):
        self.restaurant_id = "the_keg_ca"
        self.restaurant_name = "The Keg (Canada)"
        self.source_url = "https://files.thekeg.com/nutritional-guide.pdf"
    ...
    def parse_table_row(self, cells, current_category):
        ...
        row = {
            ...
            "sodium_mg": self.safe_int(numbers, 7),
            "carbs_g": self.safe_float(numbers, 8),
            "sugar_g": self.safe_float(numbers, 10),
            "protein_g": self.safe_float(numbers, 11),
        }
    ...
    def scrape(self):
        pdf_path = self.download_pdf(self.pdf_url, Path("data/the_keg_nutrition.pdf"))
