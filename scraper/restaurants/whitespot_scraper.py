...
class WhiteSpotCanadaScraper:
    def __init__(self):
        self.restaurant_id = "white_spot_ca"
        self.restaurant_name = "White Spot (Canada)"
        self.source_url = "https://d37pmuejsdwcvr.cloudfront.net/2021/10/01162103/WS-Nutrition-Guide-Oct-2021-v02.pdf"
    ...
    def scrape(self):
        pdf_path = self.download_pdf(self.pdf_url, Path("data/white_spot_nutrition.pdf"))
...
if __name__ == "__main__":
    scraper = WhiteSpotCanadaScraper()
