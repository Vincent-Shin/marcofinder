...
class OldSpaghettiFactoryCanadaScraper:
    def __init__(self):
        self.restaurant_id = "old_spaghetti_factory_ca"
        self.restaurant_name = "The Old Spaghetti Factory (Canada)"
        self.source_url = "https://oldspaghettifactory.ca/wp-content/uploads/2023/05/Nutrition.pdf"
    ...
    def looks_like_category_row(self, cells):
        ...
        has_any_rest = any(x for x in rest)
    ...
    def scrape(self):
        pdf_path = self.download_pdf(self.pdf_url, Path("data/old_spaghetti_factory_nutrition.pdf"))
...
if __name__ == "__main__":
    scraper = OldSpaghettiFactoryCanadaScraper()
